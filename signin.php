...
<body background="photo/pic3.jpg">
 ...
 <table style="background:rgb(87, 83, 114)" class="table table-borderless">
    <tr>
        <td style="font-weight: 900;">Email Id</td>
        <td><input type="text" class="form-control"></td>
    </tr>
    <tr>
        <td style="font-weight: 900;">Password</td>
